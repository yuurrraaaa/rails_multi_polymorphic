class ResearchesController < ApplicationController
  ...
  # GET /researches/new
  def new
    @research = Research.new(procedure: Aad.new)
    @research.vector_data << VectorDatum.new(data: AadDatum.new)
    @research.vector_data << VectorDatum.new(data: AadDatum.new)
  end
  ...
  def create
    ...
    # @research.procedure = procedure_class.new(procedure_params)
  ...
  private
    ...
    def research_params
      ...
      # params.require(:research).except(:procedure, :vector_data).permit(:procedure_id, :procedure_type, :start_time, :end_time, :doctor)
    end

    def procedure_params
      params.require(:research).require(:procedure).permit!
    end

    def procedure_class
      @research.procedure_type.constantize
    end

    def vector_data_params
      params.require(:research).require(:vector_data)
    end
end
